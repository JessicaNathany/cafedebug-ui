...
| Feature                               | Status        | Path                                             | Description                                                                                                                                |
| ------------------------------------- | ------------- | ------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------ |
| Railway Production Deployment         | `In progress` | `.specs/platform/railway-production-deployment/` | Deploys the fixture-backed website and authenticated backoffice as small persistent Railway services alongside the existing API and MySQL. |
