...
| Feature                               | Status        | Path                                             | Description                                                                                                                                |
| ------------------------------------- | ------------- | ------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------ |
| Railway Production Deployment         | `Ready for review` | `.specs/platform/railway-production-deployment/` | Deploys the fixture-backed website and authenticated backoffice as small persistent Railway services alongside the existing API and MySQL; GitHub owner setup and live evidence remain pending. |
...
| GitHub Actions CI Validation Redesign | `Superseded`  | `.specs/platform/ci-validation-redesign/`        | Historical admin-only CI contract, replaced by Railway production validation.                                                              |
