...
export default function EpisodeDetailError({ reset }: { reset: () => void }) {
  return (
    <main className="w-full bg-background px-4 py-16 text-foreground sm:px-6 md:px-10 lg:px-16">
      <section aria-labelledby="episode-detail-error-title" className="mx-auto grid w-full max-w-xl gap-4 rounded-m bg-card p-6 ring-1 ring-inset ring-border">
        <p className="font-primary text-xs font-semibold tracking-widest text-primary">EPISÓDIO</p>
        <h1 className="font-secondary text-2xl font-bold" id="episode-detail-error-title">
